...
interface concentScreenProps { setPolicyAccepted: React.Dispatch<React.SetStateAction<boolean>> }
        ...
        <View style={{
            ...
            <Animated.ScrollView
                ...
                <View
                    ...
                    <Text style={{ fontSize: 25, textAlign: "center", marginTop: 25, fontWeight: "bold", color: "#777777" }}>Confirm your choices</Text>
                    <Text style={{ marginTop: "10vh", textAlign: "left", width: "100%", paddingHorizontal: 20, color: "#444444", fontSize: 16 }}>
                    ...
                    <Text style={{ color: "#444444", fontSize: 16, marginTop: 100, width: "100vw", paddingHorizontal: 20, textAlign: "left", marginBottom: 100 }}>
                        <Text style={{ fontWeight: "bold", }}>Make sure you read the following</Text>
                        <Text style={{ marginTop: 10, fontSize: 12 }}>{"\n"}if you choose to proceed than you agree with terms and conditions and privacy policy</Text>
                    </Text>
                </View>
            </Animated.ScrollView>
            <div>
