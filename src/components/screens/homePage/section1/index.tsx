...
export default (props: Props) => {
  const data = useStaticQuery(graphql`
    query {
      mobileImage: file(
        relativePath: { eq: "homepage/section1/main-mobile.png" }
      ) {
        childImageSharp {
      ...
      desktopImage: file(relativePath: { eq: "homepage/section1/main.png" }) {
        childImageSharp {
...
const OverlaySection = () => {
  const pathStyles = [
    styles.svgFill_red,
    styles.svgFill_yellow,
    styles.svgFill_green,
    styles.svgFill_cyan,
    styles.svgFill_blue,
  ]
  const onHighlighterClick = ({ id }) => {
    ...
    if (
      !document
        .getElementById("homeSec1_Overlay")
        .classList.contains(styles.overlayContainer_clear)
    ) {
      console.log("clearing main overlay")
      document
        .getElementById("homeSec1_Overlay")
        .classList.add(styles.overlayContainer_clear)
    }
    ...
    >
      ...
      >
        ...
        <div className={styles.sec1TextContainer}>
          <h1 style={{ filter: "drop-shadow(1px 1px 1px #ffffff)" }}>
            Decorating Spaces
          </h1>
        </div>
      </div>
      ...
      <div
        className={
          styles.dotContainer +
          " " +
          styles.dot1Container +
          " " +
          styles.dotAnimation
        }
        onClick={() => {
          onHighlighterClick({ id: 1 })
        }}
      >
      ...
      {width >= 576 && (
        <div
          className={
            styles.dotContainer +
            " " +
            styles.dot2Container +
            " " +
            styles.dotAnimation
          }
          onClick={() => {
            onHighlighterClick({ id: 2 })
          }}
        >
          <div className={styles.outerCircle}>
            {/*  <div className={styles.innerCircle} /> */}
      ...
      {width >= 576 && (
        <div
          className={
            styles.dotContainer +
            " " +
            styles.dot3Container +
            " " +
            styles.dotAnimation
          }
          onClick={() => {
            onHighlighterClick({ id: 3 })
          }}
        >
          <div className={styles.outerCircle}>
            {/*  <div className={styles.innerCircle} /> */}
      ...
      <div>
        ...
        <div
          id="highlighter1"
          className={
            styles.highlighter1 + " " + styles.highlighterTransition + " "
          }
        />
        {width >= 576 && (
          <div
      ...
      >
        ...
        >
           ...
           */}
          {width >= 576 && (
            <ellipse id="LightPath1" cx="10vw" cy="20vw" rx="20vw" ry="30vw" />
          )}
          {width >= 576 && (
            <ellipse
              id="LightPath2"
          ...
          {width >= 576 && (
            <ellipse id="LightPath3" cx="85vw" cy="25vw" rx="30vw" ry="30vw" />
          )}
          {/* mobile - Lightpath1 */}
          {width < 576 && (
            <ellipse id="LightPath1" cx="30vw" cy="80vw" rx="50vw" ry="100vw" />
          )}
        </svg>
      </div>
    </div>
