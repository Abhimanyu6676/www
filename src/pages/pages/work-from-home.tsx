      ...
      >
        ...
        >
          <div style={{ position: "relative" }}>
            <Img fluid={data.wfhImg1.childImageSharp.fluid} style={{ minHeight: "60vh" }} />
            <div
              style={{
                color: "#fff",
                position: "absolute",
            ...
            >
              ...
              <h3 style={{ marginTop: 20, fontWeight: 400 }}>DECK OUT YOYR WORKSPACE WITH SOME USEFULL LIGHTS</h3>
            </div>
          </div>
          <p
            style={{
          ...
          >
            As working from home becomes the new normal for many, adapting the home into a productive workspace is more important than ever. We don’t
            pretend to have all the answers, but below you'll find a few light related tips that have helped the LIFX Team with the transition.
          </p>
        </div>
