...
export default (props: Props) => {
  ...
  const login = async () => {
    if (!loginBusy) {
      ...
      //let serverAdd = "https://huelite.in/development/alexa/auth"
      //let serverAdd = "https://huelite.in/backend/alexa/auth"
      //let serverAdd = "http://199.192.25.77:4000/backend/alexa/auth"
