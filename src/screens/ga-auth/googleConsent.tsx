...
export default (props: {
  setConsentPass: React.Dispatch<React.SetStateAction<boolean>>
}) => {
    ...
    <div style={{ flex: 1 }}>
      ...
      >
        <p style={{ fontSize: 18, fontWeight: "bold" }}>
          Data to be shared with Google
        </p>
        <p style={{ marginTop: 10 }}>
          1. All your HUElite devices List linked with account {user} will be
          shared
        </p>
      </div>
      ...
      >
        <p>
          Review Google's{" "}
          <a href="http://policies.google.com/">privacy policy</a>
        </p>
        <p>
